...
/*   Updated: 2025/06/24 17:30:45 by vovashko      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
class Response {
    private:
        ...
        bool _autoindexEnabled; // Flag to indicate if autoindex is enabled for the location
        bool _isCgiRequest; // Flag to indicate if the request is a CGI request
