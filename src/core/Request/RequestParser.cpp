...
// /*   Updated: 2025/06/13 12:12:25 by vovashko      ########   odam.nl         */
// /*                                                                            */
// /* ************************************************************************** */
...
// bool RequestParser::isChunkedTransfer(const Request &request) const
// {
...
// void RequestParser::parseBody(std::string &body, Request &request)
// {
...
// void RequestParser::parseFirstLineAndHeaders(std::string firstLine_and_headers, Request &request)
// {
...
// std::unordered_map<int, Request>        RequestParser::handleIncomingRequest(int fd, const std::string &raw_data)
// {
//     std::unordered_map<int, Request> resultMap;
